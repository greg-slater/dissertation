...
- The slides for a presentation about the project I gave at Westmisnter City Council are available [here](https://github.com/greg-slater/dissertation/blob/master/pdf/Westminster Presentation - G Slater.pdf).
...
```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="80%", fig.align="center", paged.print=FALSE, fig.cap= "Table 1: List of relevant policy quotes"}
knitr::include_graphics('images/t_2_policy_quotes.png')
```

```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="80%", fig.align="center", paged.print=FALSE, fig.cap= "Table 2: Services delivered by urban GI, along with benefits and datasets chosen for indicators"}
knitr::include_graphics('images/t_4_service_benefit_demand.png')
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", fig.align="center", paged.print=FALSE, fig.cap= "Figure 1: Final model process flow (PCA = Principal Component Analysis, Exponential Trans. = Exponential Transformation)"}
knitr::include_graphics('images/d_1_ci_process_flow.png')
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", fig.align="center", paged.print=FALSE}
knitr::include_graphics('images/m_4_westminster_demand_gi.png')
```
```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", fig.align="center", paged.print=FALSE}
knitr::include_graphics('images/m_4_westminster_demand_domains.png')
```
```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", fig.align="center", paged.print=FALSE, fig.cap= "Figure 2: Overall demand deciles for Westminster (1 = lowest demand, 10 = highest demand)"}
knitr::include_graphics('images/m_4_westminster_demand_indicators.png')
```

<br></br>

Westminster ranks 8th highest of all London boroughs for GI demand overall (shown in figure \ref{c_16_decomposed_lads}), and the average indicator scores for the borough (figure \ref{c_17_westminster_indicators}) make it clear again this is driven by high average levels in air pollution and noise indicators, while the average cultural indicator scores all remain low. Figure \ref{c_18_best_worst_indicators}, which shows the average levels for the four highest and lowest scoring boroughs, illustrates that high regulating indicator scores are driving high overall demand in central London, though some of the highest scoring boroughs do score highly in at least one cultural indicator.

<br></br>

```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", fig.align="center", paged.print=FALSE, fig.cap= "Figure 3: Mean GI demand index score by LAD, with decomposed indicator scores highlighted"}
knitr::include_graphics('images/c_16_decomposed_lads.png')
```

```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="30%", fig.align="center", paged.print=FALSE, fig.cap= "Figure 4: Decomposed indicator scores - Westminster"}
knitr::include_graphics('images/c_17_westminster_indicators.png')
```

```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="80%", fig.align="center", paged.print=FALSE, fig.cap= "Figure 5: Decomposed indicator scores - Four highest and four lowest scoring LADs"}
knitr::include_graphics('images/c_18_best_worst_indicators.png')
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", fig.align="center", paged.print=FALSE}
knitr::include_graphics('images/d_3_clusters_page_1.png')
```

```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", fig.align="center", paged.print=FALSE, fig.cap= "Figure 6: Cluster descriptions"}
knitr::include_graphics('images/d_3_clusters_page_2.png')
```


<br></br>

Examining the cluster results in closer detail for Westminster (figure \ref{m_8_westminster_clusters_all}) shows a large area covered by cluster 3, which represents high demand across the temperature, air pollution and noise indicators, and areas on the north and western boundaries classed as low-demand cluster 2. Cluster 7 and 8 highlight areas where GI should be prioritised to deliver flood and temperature regulation services.


```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", fig.align="center", paged.print=FALSE, fig.cap= "Figure 7: Cluster map for Westminster"}
knitr::include_graphics('images/m_8_westminster_clusters_all.png')
```
